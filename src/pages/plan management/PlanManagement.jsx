...
//               <button
//                 onClick={() => navigate(`/plan/${item.id}/edit`)}
//                 className="w-full py-2 bg-Primary text-white rounded-md mt-auto"
//               >
//                 Edit
//               </button>
//             </div>
...
//       {/* Nested modal route renders here */}
//       <Outlet context={{ priceData, handleUpdate }} />
//     </div>
//   );
// };
        ...
        {priceData.map((item) => (
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <button
                onClick={() =>
                  navigate(`/plan/${item.id}/edit`, { state: { handleUpdate } })
                }
                className="w-full py-2 bg-Primary text-white rounded-md mt-auto"
              >
                Edit
